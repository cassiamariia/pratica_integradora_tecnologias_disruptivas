        ...
        <CardContent sx={{
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Button color="secondary" size="small" variant="contained" onClick={handleEditar}>Salvar</Button>
              </Grid>  
              <Grid item xs={1}>  
                <Button color="secondary" size="small" variant="outlined" onClick={handleCloseEditar}>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
